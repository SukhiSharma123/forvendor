# Generated by Django 3.2.6 on 2021-09-20 09:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('month', models.CharField(choices=[('BAISAKH', 'baisakh'), ('JESTHA', 'jestha'), ('ASAR', 'asar'), ('SHRAWAN', 'shrawan'), ('BHADRA', 'bhadra'), ('ASOJ', 'asoj'), ('KARTIK', 'kartik'), ('MANGSIR', 'mangsir'), ('POUSH', 'poush'), ('MAGH', 'magh'), ('FALGUN', 'falgun'), ('CHAITRA', 'chaitra')], max_length=20, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Vendor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kmonth', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='proapp.month', verbose_name='kharid')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bmonth', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='proapp.month', verbose_name='bmonth')),
            ],
        ),
    ]
